<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <a class="text-blue-500 " href="{{ route('admin-kontrakan.index') }}">Kontrakan Dashboard</a>
            <span>&raquo</span>{{ __('Edit Kontrakan') }}
        </h2>
    </x-slot>
        ...
        <div class="bg-gray-100 mx-auto max-w-6xl py-20 px-12 lg:px-24 shadow-xl mb-24">
            ...
            <form action="{{ route('admin-kontrakan.update', $item->id) }}" method="POST" class="w-full"
                ...
                <div class="bg-white border shadow-md px-8 pt-6 pb-8 mb-4 flex flex-col h-full">
                    ...
                    <div class="-mx-3 md:flex mb-1">
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input value="{{ old('district') ?? $item->district }}" name="district"
                                class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                        ...
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0 h-1">
                            ...
                            <input value="{{ old('regency') ?? $item->regency }}" name="regency"
                                class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                    ...
                    <div class="-mx-3 md:flex mb-1">
                        <div class="md:w-full px-3">
                            ...
                            <input value="{{ old('gmap_url') ?? $item->gmap_url }}" name="gmap_url"
                                class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                        ...
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <div>
                                <select name="users_id"
                                    ...
                                    id="location">
                                    <option value="{{ $item->user->id }}" selected>{{ $item->user->name }}
                                    </option>
                                    @foreach ($userData as $itemUser)
                        ...
                        <div class="md:w-1/2 px-3 mb-1 md:mb-0">
                            ...
                            <div>
                                <select name="tags"
                                    class="w-full bg-gray-200 border border-gray-200 text-black text-xs py-3 px-4 pr-8 mb-3 rounded"
                                    id="location">
                                    <option value="{{ $item->tags }}" selected>{{ $item->tags }}</option>
                    ...
                    <div class="-mx-3 md:flex mb-1">
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <div>
                                <input value="{{ old('whatsapp_number') ?? $item->whatsapp_number }}"
                    ...
                    <div class="-mx-3 md:flex mb-1">
                        <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <div>
                                <input value="{{ old('latitude') ?? $item->latitude }}" name="latitude"
                                    class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                        ...
                        <div class="md:w-1/2 px-3 mb-1 md:mb-0">
                            ...
                            <div>
                                <input value="{{ old('lontitude') ?? $item->longtitude }}" name="longtitude"
                                    class="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3"
                    ...
                    <div class="-mx-3 md:flex mb-1">
                        <div class="md:w-full px-3">
                            <input type="hidden" name="oldImage" value="{{ $item->picture }}">
                        ...
                        <div class="md:w-full px-3">
                            ...
                            <div class="flex justify-center">
                                <div class="rounded-lg shadow-lg bg-white max-w-sm">
                                    <a href="#!">
                                        <img class="rounded-t-lg" src="{{ asset($item->picture) }}" alt=""
                                            style="height: 200px" />
                                    </a>
                ...
                <div class="-mx-3 md:flex mt-8">
                    <div class="md:w-full px-3">
                        <button
                            class="md:w-full bg-orange-700 hover:bg-orange-500 text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 border-gray-400 hover:border-gray-100 rounded-full">
                            Update
                        </button>
                    </div>
                </div>
